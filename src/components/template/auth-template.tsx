...
const AuthTemplate = () => {
    return (
        <div
            className={
                "template min-h-screen !place-items-start !gap-4 bg-primaryLight/60 !p-0 [&>.auth-form]:p-4 md:[&>.auth-form]:gap-4 lg:[&>.auth-form]:gap-5 [&>.auth-form_.hk-text-box]:bg-white"
            }
        >
            <AuthHeader />
